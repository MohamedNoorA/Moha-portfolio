...
const Footer = () => {
  ...
  // For media queries and hover effects
  const mediaStyles = `
        ...
        <div style={styles.container}>
          <div style={styles.content} className="footer-content">
            <div style={styles.info} className="footer-info">
              <h2 style={styles.title} className="footer-title">Mohamed</h2>
              <p style={styles.subtitle}>Frontend Developer</p>
            </div>
            <div style={styles.socialLinks}>
              <a href="https://github.com/mohamedNoorA" 
              ...
              <a href="https://linkedin.com/in/mohamed-adan" 
                 style={styles.socialLink} 
                 className="social-link"
                 aria-label="LinkedIn">
                <svg style={styles.socialIcon} fill="currentColor" viewBox="0 0 24 24">
          ...
          <div style={styles.copyright}>
            ...
            <p style={{marginTop: '0.5rem'}}>Bachelor of IT student at Mount Kenya University</p>
          </div>
        </div>
      </footer>
    </>
